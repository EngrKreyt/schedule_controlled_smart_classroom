<template>
	<v-dialog
		v-model="toggleFacultyAccountCreateModal"
		...
		<v-card class="pa-5">
			...
			<v-card-actions class="pa-0 mt-4">
				...
				<v-btn
					...
					@click="toggleFacultyAccountCreateModal = false"
				>
					Close
				</v-btn>
...
<script>
	...
	export default {
		name: 'FacultyAccountCreateModal',
		props: {
			toggleFacultyAccountCreateModal: {
				type: Boolean,
				required: true
			}
		},
		...
		watch: {
			toggleFacultyAccountCreateModal() {
				...
				if (this.toggleFacultyAccountCreateModal === false) {
					this.$emit('close-faculty-account-create-modal')
					this.firstName = null
					this.lastName = null
					this.password = null
